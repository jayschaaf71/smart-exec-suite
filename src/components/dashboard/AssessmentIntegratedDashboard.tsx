...
import { ImplementationWizard as EnhancedImplementationWizard } from '@/components/implementation/EnhancedImplementationWizard';
import { SuccessMetrics as EnhancedSuccessMetrics } from '@/components/metrics/EnhancedSuccessMetrics';
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="metrics">Metrics & Progress</TabsTrigger>
          </TabsList>
